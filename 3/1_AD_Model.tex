...
As mentioned in \cref{chap-ps-metrics} we wish to achieve a generalization of the Minkowski metrics by inspecting the properties decomposability, intradimensional subtractivity and interdimensional subtractivity which correspond to the first three steps mentioned after \cref{def-minkowski-metric}.
Here, we will define these terms for proximity structures and then remark how they translate to the real numbers.
