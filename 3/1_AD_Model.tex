\chapter{Additive Difference Models and Structures}

\section{Additive Difference Model}
...
\begin{defi}[Additive Difference Model] 
    ...
    \item \emph{Decomposability}: The distance between stimuli is a function of componentwise contributions.\\ \index{Decomposability}
        ...
        \item \emph{Interdimensional additivity}: The distance is a function of the sum of componentwise contributions. \index{Intradimensional additivity}
		...
		\item \emph{Additive-difference model}: If both, additivity and subtractivity are assumed, we get the additive difference model.
		      \begin{equation}\label{add-diff-model} \index{Additive Difference Model}
