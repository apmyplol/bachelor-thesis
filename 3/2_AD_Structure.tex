...
%
\begin{thm}[Representation and Uniqueness Theorem for AD Structures]\label{thm-repr-add-diff-struct} \index{Representation and uniqueness theorem!for additive-difference structures}
