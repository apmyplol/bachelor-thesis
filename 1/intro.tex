...
% Critics by physicist, most notably campbell
...
Later, philosophers, mathematicians and psychologists, namely Patrick Suppes, David H. Krantz, R. D. Luce, Amos Tversky and others developed the representational measurement theory, which also proved the claims of Campball to be incorrect.
This theory aims to create a more rigorous and axiomatized foundation for measurement and can be found in the three volumes of Foundations of Measurement.
...
If we consider similarity of colors, for example, we cannot simply use the empirical structures described above as there is no simple $\succsim$ relation for colors, i.e., there is no direct way to compare two colors.
...
In this thesis we focus on proximity structures and present empirical and numerical structures and the representation and uniqueness theorems associated with them.
