\begin{sourcescontribs} \label{sec-combining-sources}
  ...
  \cref{lemma-distance} was inspired by a post on math stackexchange \parencite{stackexchange}.\\
  The definitions and convexity results in \cref{sec-ball-convexity} are based on Chapters 1.1 to 1.4 of \textcite[pp. 1-38]{lecturesConvGeo}. Most other arguments have been briefly outlined.
