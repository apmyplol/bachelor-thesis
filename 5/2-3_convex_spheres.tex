...
In this subsection we will prove the following lemma which is needed to conclude the proof of \cref{thm-homogeneity}. Everything will be assumed as in \cref{thm-homogeneity}. Note, that all topological terms are with respect to the natural topology of the Euclidean space.
...
\end{lem}
First, we will state some definitions and results on basic convex geometry that we need, and prove the lemma at the end of this section. The definitions and results on convex geometry are taken out of \textcite{lecturesConvGeo}.
