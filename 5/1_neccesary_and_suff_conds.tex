...
\begin{proof}[Proof of \crefpart{necc-suff-conds}{necc-cond}]

According to the assumptions of the theorem, there exists a metric $\delta$ on $A$ and an increasing function $G$, such that for all $a, b \in A$,
