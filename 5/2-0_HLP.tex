...
Both, the proof and the definitions are based on \parencite[p. 66-69]{hardy1952inequalities} and \parencite[p. 271-273]{handbookMeans}.
...
\begin{proof}
  ...
  \begin{proofpart}[$\Rightarrow$]
    ...
    \begin{equation*}
      \phi(w_1 x_1 + w_2 + x_2) = w_1 \psi(x_1) + w_2 \psi(x_2) \quad x_1, x_1 \in \mathbb{R}_{\geq  0}.
    \end{equation*}
    In particular, this holds for $w_1, w_2 = 1/2$ which then reduces to
    \begin{equation*}
      \phi \left (\frac{x_1 + x_2}{2}\right ) = \frac{\phi(x_1)}{2} + \frac{\phi (x_2)}{2} \quad x_1, x_1 \in \mathbb{R}_{\geq  0}.
    \end{equation*}

    %QUES: ask if I have to further explain this part
