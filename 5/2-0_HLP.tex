\subsection{Uniqueness Proof for Homogeneous Means} \label{HLP_proof}
...
\begin{thm}[Characterization of equal means] \label{quasi-mean-equal-cond}
  In order that
  $$
...
\begin{thm}[$\meanrempty$ are the only homogeneous means $\meanempty$] \label{power-mean-uniquemess}
