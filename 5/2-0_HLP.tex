...
\begin{defi}[Quasi Arithmetic Means and Homogeneity] \index{Quasi-arithmetic mean} \index{Quasi-arithmetic mean!homogeneous}
...
\begin{defi}[Power mean] \index{Power mean}
