...
\begin{defi}[Convex Combination and Hull] \label{def-conv-and-comb-hull}
	...
	\begin{enumerate}
    \item Let $k \in \mathbb{N}$, let $\ve{x_1}, \dots, \ve{x_k} \in \mathbb{R}^{n}$, and let $a_1, \dots, a_k \in [0,1]$ be such that $a_1 + \dots + a_k = 1$. Then $a_1 \ve{x_1} + \dots + a_k \ve{x_k}$ is called a \emph{convex combination} of the points $\ve{x_1}, \dots, \ve{x_k}$. \index{Convex!combination}
...
\begin{thm} \label{thm-conv-hull-all-conv-combs}
	...
	$$
		\co(A) =  \left \{\sum_{i=1}^{k} a_i \ve{x_i} : k \in \mathbb{N}, \ve{x_1}, \dots, \ve{x_k} \in A, a_1, \dots, a_k \in [0,1]: \sum_{i=1}^{k} a_i = 1 \right \}
	$$
\end{thm}
...
\begin{defi}[Extreme Point]\label{def-extreme-point} \index{Extreme point}
  Let $A \subset \mathbb{R}^{n}$ be closed and convex. A point $\ve{x} \in A$ is called an \emph{extreme point of $A$} if $\ve{x}$ cannot be represented as a nontrivial (or strict) convex combination of points of A, that is, if $\ve{x} = a \cdot \ve{y} + (1-a) \cdot \ve{z}$ with $\ve{y}, \ve{z} \in A$ and $a \in (0,1)$, implies that $\ve{x} = \ve{y} = \ve{z}$. The set of all extreme points of $A$ is denoted by $\extr(A)$.
\end{defi}
...
\begin{proof}
  $\metric : S' \times S' \to \mathbb{R}_{\geq 0}$ is continuous with $S' \subseteq \mathbb{R}^n$ and therefore $\ve{y} \mapsto \metro{\ve{y}} = \metr{\ve{0}}{\ve{y}}$ is continuous.
    ...
    \metric^{-1}(U') & = \{\ve{y} \in S' : \metro{\ve{y}} \in U'\}        \\
                     & = \{\ve{y} \in S' : \metr{\ve{0}}{\ve{y}} \leq \alpha\} \\
		                 & = \cball{\alpha}
	\end{align*}
...
\begin{lem}[compressing extreme points] \label{lem-compr-extr-points}
  ...
  Then, $\ve{y} \in \E[\alpha]$ implies $\frac{1}{r}\ve{y} \in \E[\frac{\alpha}{r}]$.
\end{lem}
...
\begin{proof}~\\
  ...
  Assume, that $\frac{1}{r}\ve{y}$ is not an extreme point, i.e. $\frac{1}{r}\ve{y} \in \CO[\frac{\alpha}{r}] \setminus \E[\frac{\alpha}{r}]$.
  Then we can write $\frac{1}{r}\ve{y}$ as a strict convex combination of elements $\w \in \CO[\frac{\alpha}{r}]$:
  $$\frac{1}{r}\ve{y} = \sum_{i=1}^p \lambda_i \w \quad \text{with } \sum_{i=1}^p \lambda_i = 1, \quad \lambda_i > 0,~ \w \in \CO[\frac{\alpha}{r}] \text{ and } p \in \mathbb{N} $$
  ...
  This yields, that $\ve{y} = \sum_{i=1}^{p} \lambda_i r \w$ is a strict convex combination (because $\lambda_i r \neq 0$) and therefore $\ve{y}$ is not in $\E$.
\end{proof}
...
\begin{proof}[Proof of \cref{lem-metr-spheres-convex}] \label{proof-metr-spheres-convex}
  ...
  \newcommand\yy[1][i]{\ve{y^{(#1)}}}
	...
	\begin{align*}
		\metr{\ve{0}}{\sum_{i=1}^{r} \frac{1}{r} \yy} & \leq \metr{\ve{0}}{\frac{1}{r}\yy[1]} + \metr{\frac{1}{r}}{\sum_{i=1}^{r} \frac{1}{r}\yy} \tag{triangle inequality} \\
		                                         & = \metr{\ve{0}}{\frac{1}{r}\yy[1]} + \metr{\ve{0}}{\sum_{i=2}^{r} \frac{1}{r}\yy} \tag{translation invariance}           \\
		                                         & \leq \frac{\alpha}{r} + \metr{\ve{0}}{\sum_{i=2}^{r} \frac{1}{r}\yy} \tag{translation invariance}                   \\
		                                         & \dots \tag{repeat}                                                                                             \\
