...
Notation:
    ...
    In this section we will prove the main lemma, which is needed for the proof of the main result %TODO: ref adden.
...
Now, we will move to the proof of the main lemma. It is suggested to first read the proof to get the main ideas and a big picture understanding, and then read the next section which covers the convexity of spheres.
...
\begin{proof}
  ...
  By \cref{lemma-small-delta-balls}, there exists $\alpha > 0$ such that $\ball{\alpha} \subset \ball[\infty]{\alpha}$, and by translation invariance this holds for all points on the line: $\ball{\alpha}{t z} \subset S$ for all $t \in [0,1]$.
