\subsection*{Preliminary lemma} \label{sect-homogeneity-lemma}
...
In this section we will prove the main lemma, which is needed for the proof of the main result \cref{thm-uniquene-repr-minkowski}.
