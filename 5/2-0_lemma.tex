  ...
  \begin{proofpart}[$t \metro{\ve{z}} \leq \metro{t \ve{z}}$ for $t = \frac{1}{m} < d$ with $m \in \mathbb{N}$]\label{lemma-part1}
    ...
    \metr{\z[k-1]}{\z[k]} = \metr{\z[k-2]}{\z[k-1]} = \dots = \metr{\z[1]}{\z[0]} = \metr{\z[1]}{\ve{0}} = \frac{1}{m} \metr{\ve{0}}{\z}.
      ...
      \metr{\ve{0}}{\z}          & \leq \metr{\ve{0}}{\z[1]} + \metr{\z[1]}{\z[2]} + \dots + \metr{\z[m-1]}{\z[m]} \\
                                 ...
                                 & = \metr{\ve{0}}{\z}                                                              \\[1ex]
      \implies \metr{\ve{0}}{\z} & = \metr{\ve{0}}{\z[1]} + \metr{\z[1]}{\z[2]} + \dots + \metr{\z[m-1]}{\z[m]}
		\end{align*}

    %TODO: maybe zsm in einen align block und referencen, tags adden bissi wenig text
    For the distance $\metr{\ve{0}}{\z[2]}$, we get the following two inequalities:
		\begin{enumerate}
      \item $$ \metr{\ve{0}}{\z[2]} \leq \metr{\ve{0}}{\z[1]} + \metr{\z[1]}{\z[2]} = \frac{2}{m} \metr{\ve{0}}{\z} $$
			\item \begin{align*}
          \metr{\ve{0}}{\z}     & \leq \metr{\ve{0}}{\z[2]} + \metr{\z[2]}{\z}                                                  \\
          \metr{\ve{0}}{\z[2]} & \geq \metr{\ve{0}}{\z} - \underbrace{\metr{\z[2]}{\z}}_{\leq \sum_i \metr{\z[2+i]}{\z[2+i+1]}} \\
                               & \geq \metr{\ve{0}}{\z} - \sum_{i=0}^{m-3} \metr{\z[2+i]}{\z[2+i+1]}                           \\
                               & = \metr{\ve{0}}{\z} - \frac{m-2}{m} \metr{\ve{0}}{\z}                                              \\
                               & = \frac{2}{m} \metr{\ve{0}}{\z}
			      \end{align*}
		\end{enumerate}

    These two inequalities yield $\metr{\ve{0}}{\z[2]} = \frac{2}{m} \metr{\ve{0}}{\z}$.
