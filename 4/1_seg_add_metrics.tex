...
This chapter is based on \textcite[Chapter 1]{busemann} and Chapters 12.3.1 and 14.2 from \textcite{foundations2}. A more detailed explanation of the sources can be found at the end of the chapter.
...
The remark we provide on the arc length is intuitive and states that the arc length is continuous and non-decreasing.
