\section{Segmentally Additive Proximity Structures}
...
\begin{defi}[Ternary Relation on Proximity Structures]
...
\begin{thm}[Representation Theorem for Segmentally Additive Proximity Structures]\label{seg-add-ps-repr-thm} \index{Representation theorem!segmentally additive proximity structure}
