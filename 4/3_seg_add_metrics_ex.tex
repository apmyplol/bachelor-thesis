\section{Examples} \label{sect-seg-add-ex}
...
\begin{ex}[Segmental Additivity of the Minkowski Metric] \label{ex-minkowski-seg-additive}
  ...
  For $p \geq 1$ the Minkowski Metric is a metric with additive segments\footnote{This is shorthand for: $\mathbb{R}^n$ with the Minkowski metric is a metric space with additive segments.}. The segments are all straight lines (i.e., the line segments between two arbitrary points).
