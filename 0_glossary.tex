...
description={Ternary relation on proximity structure}, text={}}
...
\newglossaryentry{openball}{
  name={\ensuremath{\ball{r} := \{x \in \mathbb{R}^{n}: \metro{x} < r\} }},
description={The open ball with radius $r$ around $0$ wrt. the metric $\metric$}, text={}}

\newglossaryentry{closedball}{
  name={\ensuremath{\cball{r} := \{x \in \mathbb{R}^{n}: \metro{x} \leq r\} }},
